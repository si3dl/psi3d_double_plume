...
!-------------------------------------------------------------------------
   ...
   REAL, ALLOCATABLE, DIMENSION(:,:)  :: scoutm   ! Var. to output basin average temp
   REAL, ALLOCATABLE, DIMENSION(:,:,:):: troutm
   ...
   INTEGER :: iop, iox, ioi, ioc, n_planes, n_sections, n_isot, isot_points, nprof
   INTEGER, PARAMETER :: max_planes = 10, max_sections = 30, max_isot = 20
   INTEGER, PARAMETER :: max_section_cells = 200, max_nprof = 10
   ...
   INTEGER, DIMENSION (max_nprof   ) :: ilsb, ileb, jlsb, jleb
